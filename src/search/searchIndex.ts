...
export interface SearchResult {
  kind: 'instance' | 'primitive' | 'net' | 'cell';
  id: string;
  cellName: string;
  detail: string;
}
...
// instances, primitives, and nets within every cell, plus the cells
// themselves (so "search for a master cell" works even with no instances
// shown). Built once per loaded design.
